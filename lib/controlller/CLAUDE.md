...
4. **协议适配** -- 支持 V1/V2 (Vendor 0x000A) 和 V3 (Vendor 0x001D) 两种 GAIA 协议版本
5. **Vendor 自动探测** -- Auto 模式下自动尝试多个 Vendor ID 以确定设备支持的协议版本
...
| 文件 | 大小 | 说明 |
|------|------|------|
| `OtaServer.dart` | ~64KB (~2060行) | OTA 服务核心，涵盖 BLE 管理、升级状态机、RWCP 集成、日志系统 |
