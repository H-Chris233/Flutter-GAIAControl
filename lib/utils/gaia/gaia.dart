...
class GAIA {
  ...
  ///
  /// @see #acknowledgmentMask <code>acknowledgmentMask</code> to know if a command is an acknowledgement
  static const int commandMask = 0x7FFF;

  /// <p>The mask which represents an acknowledgement.</p>
  /// <ul>
  ///     <li><code>COMMAND & acknowledgmentMask > 0</code> to know if the command is an acknowledgement.</li>
  ///     <li><code>COMMAND | acknowledgmentMask</code> to build the acknowledgement command of a command.</li>
  /// </ul>
  ///
  /// @see #commandMask <code>commandMask</code> to know how to retrieve the command number
  ...
  /// source, etc.</p>
  static const int incorrectState = 6;

  /// <p>The command is in progress.</p> <p>Acknowledgements with <code>inProgress</code> status may be sent once
  ...
  static const int notNotification = 0;
